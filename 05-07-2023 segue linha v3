...
motorAbreFechaGarra = Motor(Port.C)
motorCurva = Motor(Port.D)

#inicia DriveBase
robo = DriveBase(motorEsquerdo, motorDireito, wheel_diameter=53, axle_track=225)
